#############################################################################
# Makefile for building: SimpleVector
...
ZIP           = 
DEF_FILE      = 
RES_FILE      = build/Debug/MinGW_Qt-Windows/SimpleVector_resource_res.o
COPY          = cp -f
SED           = sed
COPY_FILE     = cp -f
COPY_DIR      = cp -f -R
...
SOURCES       = main.cpp 
OBJECTS       = build/Debug/MinGW_Qt-Windows/SimpleVector_resource_res.o \
		build/Debug/MinGW_Qt-Windows/main.o

DIST          =  simplevector.h main.cpp
QMAKE_TARGET  = SimpleVector
DESTDIR        = dist/Debug/MinGW_Qt-Windows/ #avoid trailing-slash linebreak
TARGET         = SimpleVector.exe
DESTDIR_TARGET = dist/Debug/MinGW_Qt-Windows/SimpleVector.exe
...
$(DESTDIR_TARGET):  $(OBJECTS) build/Debug/MinGW_Qt-Windows/SimpleVector_resource_res.o
	$(LINKER) $(LFLAGS) -o $(DESTDIR_TARGET) $(OBJECTS)  $(LIBS)

build/Debug/MinGW_Qt-Windows/SimpleVector_resource_res.o: SimpleVector_resource.rc
	windres -i SimpleVector_resource.rc -o build/Debug/MinGW_Qt-Windows/SimpleVector_resource_res.o --include-dir=. $(DEFINES)
...
clean: compiler_clean 
	-$(DEL_FILE) build/Debug/MinGW_Qt-Windows/SimpleVector_resource_res.o build/Debug/MinGW_Qt-Windows/main.o
	-$(DEL_FILE) build/Debug/MinGW_Qt-Windows/SimpleVector_resource_res.o
...
build/Debug/MinGW_Qt-Windows/main.o: main.cpp simplevector.h
