#############################################################################
# Makefile for building: LinkedListV1
...
ZIP           = 
DEF_FILE      = 
RES_FILE      = build/Debug/MinGW_Qt-Windows/LinkedListV1_resource_res.o
COPY          = cp -f
SED           = sed
COPY_FILE     = cp -f
COPY_DIR      = cp -f -R
...
SOURCES       = main.cpp 
OBJECTS       = build/Debug/MinGW_Qt-Windows/LinkedListV1_resource_res.o \
		build/Debug/MinGW_Qt-Windows/main.o

DIST          =  linkedlist.h main.cpp
QMAKE_TARGET  = LinkedListV1
DESTDIR        = dist/Debug/MinGW_Qt-Windows/ #avoid trailing-slash linebreak
TARGET         = LinkedListV1.exe
DESTDIR_TARGET = dist/Debug/MinGW_Qt-Windows/LinkedListV1.exe
...
$(DESTDIR_TARGET):  $(OBJECTS) build/Debug/MinGW_Qt-Windows/LinkedListV1_resource_res.o
	$(LINKER) $(LFLAGS) -o $(DESTDIR_TARGET) $(OBJECTS)  $(LIBS)

build/Debug/MinGW_Qt-Windows/LinkedListV1_resource_res.o: LinkedListV1_resource.rc
	windres -i LinkedListV1_resource.rc -o build/Debug/MinGW_Qt-Windows/LinkedListV1_resource_res.o --include-dir=. $(DEFINES)
